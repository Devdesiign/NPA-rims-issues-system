...
<body>
  <div class="form__container container-sm p-3">
    ...
    <form action="login-process.php" method="post" class="form__body">
      <!-- Username -->
      <label for="username" class="form-label label username--label mt-3" id="username">Email:
      </label>
      <input type="email" name="username" id="username" class="username--field form-control" required />

      <!-- Password -->
      <label for="password" class="form-label label password--label mt-3" id="password">Password:</label>
      <input type="password" name="password" id="password" class="password--field form-control mb-3" required />
